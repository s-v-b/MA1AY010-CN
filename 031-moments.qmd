# A modicum of integration  {#moments}
...
## Limit theorems  {#biglimittheorems}
...
::: {#thm #thmdominatedConv name="Dominated convergence theorem"}
...
## Probability distributions defined by a density {#densities}
...
(ref:convexfunfig) The function $f : x \mapsto \mathbb{I}_{x<0}|x| + \mathbb{I}_{x\geq 0} x^2$ is convex, continuous. It is differentiable everywhere except at $x=0$. The dotted lines define affine functions that are below the cruve $y=f(x)$. The dotted lines define supporting hyperplanes for the epigraph of $f$.
...
## Median and interquartile range  {#medianiqr}
