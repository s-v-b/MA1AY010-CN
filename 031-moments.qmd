...
as_tibble(list(x=seq(0, 2, by=.001))) %>%
  ...
  stat_function(fun=simple(exp,2), n=2001, aes(linetype="n=2")) +
  stat_function(fun=simple(exp,3), n=2001, aes(linetype="n=3")) +
  stat_function(fun=simple(exp,4), n=2001, aes(linetype="n=4")) +
...
data1 %>%
  ...
  geom_segment(x=0, y=y, xend=x, yend=y, linetype="dashed", linewidth=.5) +
  geom_segment(x=x, y=0, xend=x, yend=y, linetype="dashed", linewidth=.5) +
