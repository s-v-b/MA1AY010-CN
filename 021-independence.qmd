# Independence and product spaces  {#independence}
...
notion is elementary, helpful. In section \@ref(indepalgebras),
the notion of independence is extended to $\sigma$-algebras.
and to random variables. We observe that checking
independence between $\sigma$-algebras is facilitated by The monotone class theorem (Theorem \@ref(thm:monotoneclasslemma)).
...
In Section \@ref(productmeasures) we define  product $\sigma$-algebras
and product measures. In Section \@ref(tonellifubini) we state the
...
expectations in product spaces. In Section \@ref(indepproduct),  we outline the
way building product spaces allows to build collections of independent random
variables. In section \@ref(indepcollectionsalgebras) we consider
...
## Independence of two events  {#indepevents}



We recall definitions from [Introductory Lesson]() \@ref(intro), Section \@ref(random-variables-and-independence)


::: {#def  name="Independence of two events"}
...
## Independence of $\sigma$-algebras and random variables {#indepalgebras}

:::: {#def name="Independence of sigma-algebras"}
...
The proof of Theorem \@ref(thm:indepmonotone) is another application of the monotone class lemma (Lemma \@ref(thm:monotoneclasslemma))
...
```{definition, name="Independence of countable collections"}
