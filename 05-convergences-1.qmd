# Convergences I : almost sure, $L_2$, $L_1$, in Probability  {#convergences1}


## Motivations {#motivconvergences}
...
## Almost sure convergence  {#asconvergence}
...
## Convergence in $L_p$  {#Lpconvergence}
...
We already introduced $L_p$ convergences in Lesson \@ref(moments). We recall it for the sake of readibility.
...
A counter-example given in Section \@ref(lpspaces) shows that convergence in $L_p$
does not imply almost-sure convergence.


## Convergence in probability {#probaconvergence}
...
::: {#def  #kyfan name="Ky-Fan distance"}
...
::: {#def #convproba name="Convergence in probability, multivariate setting"}
...
::: {#thm #wlln name="Weak  law of large numbers"}
...
::: {#thm #slln name="Strong  law of large numbers, direct part"}
...
::: {proof name="Proof of SLLN direct part"}
...
Theorem \@ref(thm:convslln) shows that, under independence assumption, the conditions in Theorem \@ref(thm:slln) are tight.
Before proceeding to the proof of Theorem \@ref(thm:convslln), we state and prove the second Borel-Cantelli Lemma.

<br> <p> </p>


::: {.lemma  name="Borel-Cantelli II"}
...
::: {#thm #convslln name="Strong  law of large numbers, converse part"}
...
::: {#def #tailalgebra name="Tail sigma-algebra"}
...
## Exponential inequalities {#expineq}
...
::: {#thm name="Hoeffding's inequality"}
...
::: {#thm #zbennett name="Bennett's inequality"}
...
::: {#thm #zbernstein  name="Bernstein's inequality"}
...
## Bibliographic remarks {#bibconvrv}
