...
## PGF for joint distributions {#sec-multivariate=pgfs}

::: {#def-multi-pgf name="Multivariate Probability Generating Function"}
...
## Conmpound distributions {#sec-compound-distributions}

::: {#def-compound-distrib  name="Compount distribution"} 
