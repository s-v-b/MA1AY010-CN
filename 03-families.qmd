# Families of discrete distributions  {#sec-families}

The goal of this lesson is getting acquainted with important families of discrete distributions and to get familiar with distributional calculus.
Discretet probability distributions will be presented through distribution functions and mostly probability mass functions.
...
A binomial distribution with parameters $n \in \mathbb{N}, p \in [0,1]$ ($n$ is size and $p$ is success) is a probability distribution $P$ on  $\Omega = \{0, 1, 2, \ldots, n\}$, defined
by
...
It is enough to check that the probability mass functions coincide. 
